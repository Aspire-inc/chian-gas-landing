...
const CustomMarketerModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
              ...
              <div className="flex flex-col items-center justify-center h-full space-y-5">
                <div className="mb-10">
                  ...
                  <p className="text-xl font-normal text-center text-[#5B5B5B]  mt-5">
                    Join our network, promote innovative gas solutions,
                    <br />
                    and earn as you empower households.
                  </p>
                </div>
...
export default CustomMarketerModal;
