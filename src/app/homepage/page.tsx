  ...
  return (
    <div className="w-full" id="home">
      ...
      <div className="bg-[#FBFAFA] w-[100%] mt-10 md:mt-20 flex flex-wrap items-center gap-y-6">
        <div className=" w-full xl:w-[calc(100%-800px)] px-5 sm:px-12 lg:pl-20">
          ...
          <p className="text-[#5B5B5B] text-[16px] sm:text-[18px] mt-1 tracking-wider lg:w-[calc(100%-100px)]">
            Manage users, riders, and vendors via admin panel. Lorem ipsum dolor sit amet,
            consectetur adipiscing elit. Mauris eget felis et felis ultrices tempus at sed eros.
            Donec pulvinar lacus a augue ultricies lacinia. Phasellus cursus elementum commodo.
            Curabitur quam sapien, pretium sed tellus at, condimentum ultricies enim. In cursus
      ...
      <div className="flex justify-center  py-10 md:py-20 relative">
        ...
        <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center text-[18px] sm:text-[26px] lg:text-[48px] px-5">
          <p className="text-center md:max-w-[80%] text-[#3F3F3F]">
            <span className="font-bold text-inherit">Chian: </span> Your convenient connection to
            gas vendors for quick and hassle-free refills. Never run out of gas again with our
            easy-to-use app.
          </p>
        </div>
      </div>
      ...
      <div className="px-5 sm:max-w-[95%] 2xl:max-w-[80%] mx-auto md:mt-20 relative">
        <div className="flex gap-10 flex-wrap lg:flex-nowrap justify-center">
          ...
          <div className="w-full lg:w-[calc(100%-500px)] order-1 lg:order-2">
            ...
            <DotDiffText>Stay informed of your gas levels in advance</DotDiffText>
            ...
            <p className="text-[#5B5B5B] text-[16px] sm:text-[18px] tracking-wider">
              Chian enables customers to monitor their gas cylinder's level through seamless
              integration with a mounted gas level indicator device, ensuring you never run out of
              gas. Stay informed in advance to plan for refills conveniently. Track and monitor the
              gas level inside your cylinder. Effortlessly manage your gas supply with real-time
              updates. Stay prepared and avoid unexpected gas shortages. Simplify your gas refilling
              process with proactive notifications.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 sm:max-w-[95%] 2xl:max-w-[80%] mx-auto mt-20 md:mt-36 lg:mt-72 relative">
        <div className="flex gap-10 flex-wrap lg:flex-nowrap justify-center">
          <div className="w-full lg:w-[calc(100%-500px)]">
            <p className="text-[#CACACA] text-[24px] 2xl:text-[36px]">LEAKAGE ALERT SYSTEM</p>
            ...
            <p className="text-[#5B5B5B] text-[16px] sm:text-[18px] tracking-wider">
              Chian prioritizes safety, and that's why the app seamlessly integrates with a gas
              leakage detector device affixed to the gas cylinder. This innovative solution actively
              monitors and swiftly alerts users the moment any gas leakage is detected. By keeping a
              vigilant eye on gas leakage right from the source, Chian ensures timely notifications
              when even the slightest leakage emerges from the cylinder. Your safety is our utmost
              concern, and we leave no room for compromise when it comes to protecting you from
              potential gas leaks.
            </p>
          </div>
      ...
      <div className="mt-28 px-5 sm:max-w-[95%] xl:max-w-[80%] mx-auto">
        <DotDiffText className="justify-center text-center">Frequently asked questions</DotDiffText>
        ...
        <div className="flex mt-10">
          <div className="w-[50%] h-[350px] hidden lg:flex items-center justify-center">
            <div className="flex gap-x-2">
              ...
              <Image src={ThinkingBoyIcon} alt="" width={170} height={170} className="mt-20" />
            </div>
          </div>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 grid-rows-3 sm:grid-rows-2 lg:grid-rows-1 gap-7">
          {newsAndUpdates.map((data, i) => (
            <div key={i} className="flex flex-col items-center md:items-start">
              ...
              <p className="text-[14px] sm:text-[16px] text-[#5B5B5B]">{data.description}</p>
