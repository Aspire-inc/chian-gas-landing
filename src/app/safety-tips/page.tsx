...
import LeftImg from "@/assets/icons/pic.svg";
    ...
    <div className="w-full px-6  xl:px-[5rem] mt-[3rem] ">
      <div className="relative grid grid-cols-2 ">
        <div className="relative flex items-center justify-center p-10 ">
          <div>
            <span className="text-blue-800 text-[80px] font-bold  tracking-wider">
              Safety Isn’t a<br />
              Costly Endeavor;
              <br />
              It's{" "}
            </span>
            <span className="text-amber-500 text-[80px] font-medium  tracking-wider">
              Invaluable
            </span>
        ...
        <div className="  z-[99999] relative">
          <div className="w-full">
            <Image src={LeftImg} alt="Left" className="w-full " />
          </div>
          <div className="absolute top-[-3rem] left-[-8rem] w-full">
            <Image src={BallonArrow} alt="bubble" className="w-full" />
          </div>
        </div>
        <div className="absolute top-0 left-[-4rem] flex flex-col justify-center h-full px-5 space-x-5 ">
