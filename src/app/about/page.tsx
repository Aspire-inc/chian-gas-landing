...
function About() {
  return (
    <div className="px-6 xl:px-10 w-full">
      <div className="w-full humans-bg border-2 flex items-center justify-start">
      ...
      <div className="flex flex-col items-center p-5 bg-white sm:p-7 border-2 ">
        <div className="flex flex-col mt-7 md:mt-14 w-[90%] border-2">
          ...
          <div className="grid grid-cols-1 grid-rows-5 mt-6 md:mt-12 md:grid-cols-2 xl:grid-cols-4 md:grid-rows-3 xl:grid-rows-2 gap-7">
          ...
          <div className="flex flex-col items-center justify-center">
            <DotDiffText className="text-center">Our Directors</DotDiffText>
            <Directors />
          </div>
        </div>
      </div>
